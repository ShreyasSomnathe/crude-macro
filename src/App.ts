    ...
    this.container.innerHTML = `
      <div class="header">
        <div class="header-left">
          ...
          <span class="logo">CRUDE MACRO</span><span class="version">v${__APP_VERSION__}</span>
          <a href="https://x.com/shreyassomnathe" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@shreyassomnathe</span>
          </a>
          <a href="https://github.com/shreyassomnathe/crude-macro" target="_blank" rel="noopener" class="github-link" title="View on GitHub">
